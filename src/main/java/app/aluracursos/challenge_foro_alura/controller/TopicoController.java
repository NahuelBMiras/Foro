...
public class TopicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosConfirmacionPostTopico>> listarTodosLosTopicos(
            @PageableDefault
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<DatosConfirmacionPostTopico> actualizarTopico(@PathVariable("id") Long id,
